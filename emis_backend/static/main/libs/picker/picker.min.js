...
! function(t, i, e, n) {
    ...
    r.prototype = {
        ...
        _createElement: function(i) {
            console.log(this.elem.attr('name'));
            var model = this.elem.attr('name');
            var e = this.config.coloring[i.data("id")],
                n = t("<span>").addClass("pc-element pc-element-open" + (e ? e : "")).text(i.text()).attr("data-id", i.data("id")).attr("data-order", i.data("order")).attr('data-model', model);
        ...
        _build: function() {
            ...
            this.$container = t("<div class='picker" + (this.config.containerClass ? " " + this.config.containerClass : "") + "'><span class='pc-select'><span class='pc-element pc-trigger'>" + this.config.texts.trigger + "</span><span class='pc-list' " + (this.config.width ? "style='width:" + this.config.width + "px; display:none;'" : "style='display:none;'") + "><ul></ul></span></span></div>"), this.config.containerWidth !== !1 && this.$container.width(this.config.containerWidth), this.$container.insertAfter(this.$elem), this.config.search && this._buildSearch()
        },
